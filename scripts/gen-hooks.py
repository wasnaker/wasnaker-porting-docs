...
FILTER_SPINE = {
    ...
    'get_current_date_format': 'DateFormatting (mutasi payload)',
    'available_date_formats': 'DateFormatting (mutasi payload)',
    'after_format_date': 'DateFormatting (mutasi payload)',
